...
The compatibility-locked prefix is now the explicit 91 IDs through HB50. This is a sequence of deliberate validation decisions, not a consequence of publication. CB1–CB3 retain stronger individually established historical fixtures. The first 37 entries retain their prior preboundary validation history; CB36–CB51 retain representative Arrancar validation; HB14 retains its separate complete proof; and the remaining 37 Hollowed entries are accepted as a representative batch under the technical and real-device basis below.
