...
This Stremio addon publishes and compatibility-locks the current 92-entry default prefix: 53 Concentrated Bleach entries from CB1 through CB51, including CB27.5 and guided CB35.5, followed by the complete 38-entry owner-selected Hollowed current-raw span from HB14 through HB50 with HB0.8 in its established position, then Chipped #01 as a one-episode compatibility POC. Chipped #01 is locked after owner-confirmed compatibility validation; Chipped #02–#12 remain reserved, unpublished, and unlocked. The first 37 entries retain their prior preboundary validation history; CB36–CB51 retain the documented representative Arrancar validation; HB14 retains its complete proof; and the remaining 37 Hollowed entries are locked from the representative real-device batch validation recorded below. **Concentrated Bleach 01 — Death and Strawberry**, **Concentrated Bleach 02 — Starter**, and **Concentrated Bleach 03 — The Pink-Cheeked Cockatiel** retain their stronger individually established historical fixtures. The Hollowed batch decision is not a claim that every episode was played end-to-end or that permanent availability is proven. This is not a full catalog and is not deployed.

Current publication and validation state:

- **Published:** exactly 92 default entries: 53 Concentrated entries through `cb_51`, all 38 owner-selected current-raw Hollowed entries through `hb_50`, then Chipped #01 / `ch_1` as the sole Season 4 entry at S4E1/global index 92. Guided CB35.5 is spreadsheet record `concentrated:0.0`, internal ID `cb_0p0`, and the final Season 2 episode at S2E28; CB36–CB51 occupy S3E1–S3E16; Hollowed occupies S3E17–S3E54.
- **Compatibility-locked prefix:** all 92 published IDs through `ch_1` are `locked:true`. Chipped #01's lock records the subsequent owner-confirmed compatibility decision; publication itself did not grant the lock.
...
- **Canonical prefix stop:** Chipped #01 (`ch_1`, `The Lost Agent`) is published and compatibility-locked at S4E1/global index 92. Chipped #02 (`ch_2`) is the first unpublished default entry at S4E2/global index 93. Concentrated CB52+ and Hollowed 51–62 are reserved source identities, not the next selected default Watch Guide entries.
...
- **Out of scope:** publishing Chipped #02–#12, extending Chipped #01's accepted compatibility result beyond the owner-confirmed scope, publishing Hollowed 11.5, 51–62, or optional/EX content, publishing Concentrated CB52+, future-v3 adoption, TorBox access by this project, deployment, and changes beyond this lock checkpoint.
