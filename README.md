...
This Stremio addon now publishes the complete 103-entry default timeline: 53 Concentrated Bleach entries from CB1 through CB51, including CB27.5 and guided CB35.5, followed by the complete 38-entry owner-selected Hollowed current-raw span from HB14 through HB50 with HB0.8 in its established position, then all twelve selected Chipped entries, Chipped #01 through #12. Publication and compatibility lock remain separate decisions: the compatibility-locked prefix currently extends only through Chipped #02 (93 of the 103 published entries); Chipped #03–#12 are published but remain unlocked pending representative real-device validation. The first 37 entries retain their prior preboundary validation history; CB36–CB51 retain the documented representative Arrancar validation; HB14 retains its complete proof; and the remaining 37 Hollowed entries are locked from the representative real-device batch validation recorded below. **Concentrated Bleach 01 — Death and Strawberry**, **Concentrated Bleach 02 — Starter**, and **Concentrated Bleach 03 — The Pink-Cheeked Cockatiel** retain their stronger individually established historical fixtures. The Hollowed batch decision is not a claim that every episode was played end-to-end or that permanent availability is proven. This is not a full catalog and is not deployed.

Current publication and validation state:

- **Published:** exactly 103 default entries — the complete default timeline: 53 Concentrated entries through `cb_51`, all 38 owner-selected current-raw Hollowed entries through `hb_50`, then all twelve selected Chipped entries, #01–#12 / `ch_1`–`ch_12`, as the Season 4 entries at S4E1–S4E12/global indexes 92–103. Guided CB35.5 is spreadsheet record `concentrated:0.0`, internal ID `cb_0p0`, and the final Season 2 episode at S2E28; CB36–CB51 occupy S3E1–S3E16; Hollowed occupies S3E17–S3E54.
- **Compatibility-locked prefix:** 93 of the 103 published IDs, through `ch_2`, are `locked:true`. Chipped #02's lock records the owner-confirmed compatibility decision documented below. Chipped #03–#12 are published with `locked:false`; publication itself does not grant a lock, and no compatibility lock has yet been recorded for #03–#12.
...
- **Canonical prefix stop:** the default 103-entry projection is now completely published; there is no unpublished default entry remaining. The compatibility-lock stop is Chipped #02 (`ch_2`, `Welcome to our EXECUTION`) at S4E2/global index 93. Chipped #12 (`ch_12`, `Goodbye to our XCution`) is the terminal published (unlocked) entry at S4E12/global index 103, and there is no default next episode after it; TYBW is not projected into this catalog. Concentrated CB52+ and Hollowed 51–62 remain reserved source identities, outside the default projection entirely, not the next selected default Watch Guide entries.
- **Chipped batch publication:** Chipped #03–#12 (`ch_3`–`ch_12`) were published together as a batch on 2026-08-24, extending the default timeline to its full 103 entries. They are not compatibility-locked. Planned representative real-device validation cases: **CH6** — the known 29.872-second discrepancy between the authoritative editorial runtime (1534s / 25:34) and the measured container duration (1504.128s); **CH10** — its third audio track (AAC LC, stereo, unresolved language) and Nuvio's audio-track presentation/selection behavior; **CH12** — terminal completion/no-next-episode behavior. These validations have not yet occurred; this entry records only that the batch was published.
...
- **Out of scope:** compatibility-locking Chipped #03–#12 before their representative real-device validation, extending Chipped #01–#02's accepted compatibility result to #03–#12 or any other untested Chipped entry, claiming the terminal focus trap or intermittent persistent audio is fixed, publishing Hollowed 11.5, 51–62, or optional/EX content, publishing Concentrated CB52+, future-v3 adoption, TorBox access by this project, deployment, and changes beyond this publication checkpoint.
...
Automated tests protect the complete 103-entry deterministic publication ending `ch_12`, and separately protect the 93-entry compatibility-locked prefix ending `hb_50`, `ch_1`, `ch_2`; preserve all prior stream, torrent, acquisition, verified-media, Concentrated, and Hollowed identities; and keep Chipped #03–#12 published but unlocked pending validation, while HB11.5, EX, Concentrated CB52+, and Hollowed 51–62 remain unpublished and unlocked. They also lock every published Chipped entry's evidence-derived presentation, including CH6's authoritative editorial runtime (1534s / 25:34, independent of its measured 1504.128s container duration) and CH10's PCM 2.0 + AAC 2.0 • JPN + ENG presentation, which omits its third audio track's user-facing language token because that track's language is exact evidence-recorded `unresolved` state while preserving the track itself and that exact state in provenance — while preserving the distinction between each entry's authoritative manga mapping and its technical filename, for example `424-428` vs `[424-427] Chipped Bleach 01.mkv` for Chipped #01, and `428-431` vs `[428-430] Chipped Bleach 02.mkv` for Chipped #02. Tests do not reproduce external compatibility experiments, the user-confirmed availability gate, or earlier manual Nuvio/TorBox experiments. The dated records preserve the terminal focus trap, intermittent persistent audio, and transient playback-unavailable incident as non-blocking observations with unresolved attribution.
