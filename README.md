...
This Stremio addon now publishes and compatibility-locks the complete 103-entry default timeline: 53 Concentrated Bleach entries from CB1 through CB51, including CB27.5 and guided CB35.5, followed by the complete 38-entry owner-selected Hollowed current-raw span from HB14 through HB50 with HB0.8 in its established position, then all twelve selected Chipped entries, Chipped #01 through #12. Chipped #03–#12 are locked from representative real-device validation, not individual playback of every entry; that validation documented an accepted known source-edit defect in the current CH6 payload and an unresolved silent-playback observation on CH10's third audio track, neither of which blocks the lock. The first 37 entries retain their prior preboundary validation history; CB36–CB51 retain the documented representative Arrancar validation; HB14 retains its complete proof; and the remaining 37 Hollowed entries are locked from the representative real-device batch validation recorded below. **Concentrated Bleach 01 — Death and Strawberry**, **Concentrated Bleach 02 — Starter**, and **Concentrated Bleach 03 — The Pink-Cheeked Cockatiel** retain their stronger individually established historical fixtures. The Hollowed batch decision is not a claim that every episode was played end-to-end or that permanent availability is proven. This is not a full catalog and is not deployed.
...
- **Compatibility-locked prefix:** all 103 published IDs, through `ch_12`, are `locked:true`. Chipped #01–#02 retain their individually recorded compatibility decisions; Chipped #03–#12's lock records the representative real-device validation documented below. Publication itself never grants a lock automatically.
...
- **Canonical prefix stop:** the default 103-entry projection is now completely published and completely compatibility-locked; there is no unpublished and no unlocked default entry remaining. Chipped #12 (`ch_12`, `Goodbye to our XCution`) is the terminal published and locked entry at S4E12/global index 103, and there is no default next episode after it; TYBW is not projected into this catalog. Concentrated CB52+ and Hollowed 51–62 remain reserved source identities, outside the default projection entirely, not the next selected default Watch Guide entries.
- **Chipped batch publication and lock:** Chipped #03–#12 (`ch_3`–`ch_12`) were published together as a batch on 2026-08-24, extending the default timeline to its full 103 entries, then compatibility-locked as a batch on the same date after representative real-device validation. Representative cases: **CH6** — exercised the known ~29.872-second discrepancy between the authoritative editorial runtime (1534s / 25:34) and the measured container duration (1504.128s); **CH10** — exercised its unusual third audio track (AAC LC, stereo, unresolved language); **CH12** — exercised terminal completion/no-next-episode behavior. Full results are recorded below.
...
- **Out of scope:** claiming CH3, CH4, CH5, CH7, CH8, CH9, or CH11 were each individually manually played end-to-end, claiming a corrected CH6 payload exists, assigning a language to CH10's third audio track or explaining its silent playback, claiming the terminal focus trap or intermittent persistent audio is fixed, publishing Hollowed 11.5, 51–62, or optional/EX content, publishing Concentrated CB52+, future-v3 adoption, TorBox access by this project, deployment, and changes beyond this lock checkpoint.
...
For the now-complete explicit 103-entry locked prefix, `locked:true` means the addon-facing identity, order, torrent, and stream compatibility contract is accepted as the stable baseline; future changes require deliberate revalidation. The first 37 entries retain their preboundary history. The CB36–CB51 extension retains its deterministic evidence and representative Arrancar coverage. HB14 retains its separately validated compatibility proof. The additional 37 Hollowed locks combine the complete deterministic 38-record technical basis and availability checkpoint with full catalog/order confirmation and the representative boundary, duration-discrepancy, corrected-torrent, and terminal samples recorded above. Chipped #01–#02 retain their separate owner-confirmed compatibility decisions; Chipped #03–#12 are locked from the representative CH6/CH10/CH12 batch validation recorded above. Publication and compatibility lock remain separate decisions; locks are applied only after explicit validation acceptance.
