...
This Stremio addon publishes the current 93-entry default prefix: 53 Concentrated Bleach entries from CB1 through CB51, including CB27.5 and guided CB35.5, followed by the complete 38-entry owner-selected Hollowed current-raw span from HB14 through HB50 with HB0.8 in its established position, then Chipped #01–#02 as a two-episode compatibility POC extension. The compatibility-locked prefix remains the first 92 entries through Chipped #01; Chipped #02 is published but unlocked pending real-device validation. The first 37 entries retain their prior preboundary validation history; CB36–CB51 retain the documented representative Arrancar validation; HB14 retains its complete proof; and the remaining 37 Hollowed entries are locked from the representative real-device batch validation recorded below. **Concentrated Bleach 01 — Death and Strawberry**, **Concentrated Bleach 02 — Starter**, and **Concentrated Bleach 03 — The Pink-Cheeked Cockatiel** retain their stronger individually established historical fixtures. The Hollowed batch decision is not a claim that every episode was played end-to-end or that permanent availability is proven. This is not a full catalog and is not deployed.

Current publication and validation state:

- **Published:** exactly 93 default entries: 53 Concentrated entries through `cb_51`, all 38 owner-selected current-raw Hollowed entries through `hb_50`, then Chipped #01–#02 / `ch_1`–`ch_2` as the Season 4 entries at S4E1–S4E2/global indexes 92–93. Guided CB35.5 is spreadsheet record `concentrated:0.0`, internal ID `cb_0p0`, and the final Season 2 episode at S2E28; CB36–CB51 occupy S3E1–S3E16; Hollowed occupies S3E17–S3E54.
- **Compatibility-locked prefix:** the first 92 published IDs through `ch_1` are `locked:true`; the 93rd, `ch_2`, remains unlocked. Chipped #01's lock records the prior owner-confirmed compatibility decision; publication itself did not grant the `ch_2` lock.
...
- **Canonical prefix stop:** Chipped #02 (`ch_2`, `Welcome to our EXECUTION`) is published but remains `locked:false` as the compatibility POC extension at S4E2/global index 93. Chipped #03 (`ch_3`) is the first unpublished default entry at S4E3/global index 94. Concentrated CB52+ and Hollowed 51–62 are reserved source identities, not the next selected default Watch Guide entries.
...
- **Out of scope:** publishing Chipped #03–#12, compatibility-locking or claiming real-device validation for Chipped #02, extending Chipped #01's accepted compatibility result beyond the owner-confirmed scope, publishing Hollowed 11.5, 51–62, or optional/EX content, publishing Concentrated CB52+, future-v3 adoption, TorBox access by this project, deployment, and changes beyond this publication checkpoint.
...
Automated tests protect the 93-entry deterministic publication ending `hb_50`, `ch_1`, `ch_2`; preserve the separate 92-entry compatibility-locked prefix ending `ch_1`; preserve all prior stream, torrent, acquisition, verified-media, Concentrated, and Hollowed identities; and keep Chipped #03–#12, HB11.5, EX, Concentrated CB52+, and Hollowed 51–62 unpublished and unlocked. They also lock Chipped #01's evidence-derived PCM/Japanese+English presentation while preserving the distinction between the authoritative manga mapping `424-428` and technical filename `[424-427] Chipped Bleach 01.mkv`. Tests do not claim or reproduce real-device Chipped #02 validation, the user-confirmed availability gate, or earlier manual Nuvio/TorBox experiments. The dated records preserve the terminal focus trap, intermittent persistent audio, and transient playback-unavailable incident as non-blocking observations with unresolved attribution.
