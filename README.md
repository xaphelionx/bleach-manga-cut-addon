...
- **Compatibility-locked prefix:** the first 91 published IDs through `hb_50` are `locked:true`; the 92nd, `ch_1`, remains unlocked. The final 37 Hollowed locks record a separate representative validation decision; publication itself did not grant those locks.
...
- **Canonical prefix stop:** Chipped #01 (`ch_1`, `The Lost Agent`) is published but remains `locked:false` as the compatibility POC at S4E1/global index 92. Chipped #02 (`ch_2`) is the first unpublished default entry at S4E2/global index 93. Concentrated CB52+ and Hollowed 51–62 are reserved source identities, not the next selected default Watch Guide entries.
...
- **Out of scope:** publishing Chipped #02–#12, compatibility-locking or claiming real-device validation for Chipped #01, publishing Hollowed 11.5, 51–62, or optional/EX content, publishing Concentrated CB52+, future-v3 adoption, TorBox access by this project, deployment, and changes beyond this publication checkpoint.
