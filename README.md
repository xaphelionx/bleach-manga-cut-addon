...
- **Compatibility-locked prefix:** all 93 published IDs through `ch_2` are `locked:true`. Chipped #02's lock records the subsequent owner-confirmed compatibility decision; publication itself did not grant the lock.
...
- **Out of scope:** publishing Chipped #03–#12, extending Chipped #01–#02's accepted compatibility result beyond the owner-confirmed scope, publishing Hollowed 11.5, 51–62, or optional/EX content, publishing Concentrated CB52+, future-v3 adoption, TorBox access by this project, deployment, and changes beyond this lock checkpoint.
...
Automated tests protect the 93-entry deterministic publication and compatibility-locked prefix ending `hb_50`, `ch_1`, `ch_2`; preserve all prior stream, torrent, acquisition, verified-media, Concentrated, and Hollowed identities; and keep Chipped #03–#12, HB11.5, EX, Concentrated CB52+, and Hollowed 51–62 unpublished and unlocked. They also lock Chipped #01's and Chipped #02's evidence-derived PCM/Japanese+English presentation while preserving the distinction between the authoritative manga mapping `424-428` and technical filename `[424-427] Chipped Bleach 01.mkv` for Chipped #01, and `428-431` and `[428-430] Chipped Bleach 02.mkv` for Chipped #02. Tests do not reproduce external compatibility experiments, the user-confirmed availability gate, or earlier manual Nuvio/TorBox experiments. The dated records preserve the terminal focus trap, intermittent persistent audio, and transient playback-unavailable incident as non-blocking observations with unresolved attribution.
